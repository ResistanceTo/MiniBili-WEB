...
export const changelog: ChangelogVersion[] = [
	{
		...
		updates: {
			improvement: [
				...
				"退出视频详情页后声音还会继续响 1–2 秒的问题。",
				"连续打开两个视频时，前一个视频在后台自动播放的问题。",
				"搜索结果里出现专栏时偶发闪退的问题。",
				"番剧页的选集按钮只显示出一半的问题。",
				"Mini 播放器（含观影模式）用手势调节音量时从 0 开始的问题。",
				"无玻璃样式下，简介区域和动态页「最常访问」栏显示异常的问题。",
				"分区页横向分区栏多出一块背景的问题。",
			],
			bugfix: [
				"【修复】",
				"偶尔退出详情页后声音一直不停、再打开一个视频会两路声音同时播放的问题；番剧和直播页同步修复。",
